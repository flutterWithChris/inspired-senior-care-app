...
class ManagerCategoriesShare extends StatefulWidget {
  ...
  @override
  State<ManagerCategoriesShare> createState() => _ManagerCategoriesShareState();
}

class _ManagerCategoriesShareState extends State<ManagerCategoriesShare> {
  final GlobalKey managerShareCategoryCardShowcaseKey = GlobalKey();
